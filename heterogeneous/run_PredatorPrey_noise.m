...
% add noise to dotX
for m = 1:M
    dotX11{m} = dotX11{m} + 2*eta*rand(size(dotX11{m}))-eta;
    dotX12{m} = dotX12{m} + 2*eta*rand(size(dotX12{m}))-eta;
    dotX21{m} = dotX21{m} + 2*eta*rand(size(dotX21{m}))-eta;
    dotX22{m} = dotX22{m} + 2*eta*rand(size(dotX22{m}))-eta;
end
