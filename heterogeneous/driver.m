...
plotKernel(phi{1},c{1},psiLib,IC.rmax,'\phi_{11} Comparison');
plotKernel(phi{2},c{2},psiLib,IC.rmax,'\phi_{12} Comparison');
plotKernel(phi{3},c{3},psiLib,IC.rmax,'\phi_{21} Comparison');
plotKernel(phi{4},c{4},psiLib,IC.rmax,'\phi_{22} Comparison');
